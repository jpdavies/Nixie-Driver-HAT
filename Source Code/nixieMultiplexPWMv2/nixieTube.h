...
public:
	...
	int getPWMHz();
	void setOnHold(int value);
	int getOnHold();
	void setOffHold(int value);
	int getOffHold();
	void setOnTO(unsigned int value);
	unsigned int getOnTO();
	void setOffTO(unsigned int value);
	unsigned int getOffTO();
	void runPWM();
};
#endif